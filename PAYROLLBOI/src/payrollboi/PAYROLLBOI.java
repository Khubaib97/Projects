...
class Hemployee extends Employee{
    ...
    public String earnings(){
        if(hours<=40){
            return "Eearned: "+wage*hours;
        }
        else{
            return "Earned: "+((40*wage)+((hours-40)*wage*1.5));
        }
    }
    public String toString(){
...
class Cemployee extends Employee{
    ...
    public String earnings(){
        return "Earned: "+grosssales*commissionrate;
    }
    public String toString(){
...
class BPCemployee extends Cemployee{
    ...
    public String earnings(){
        return "new base salary is: "+(basesalary)+"\nEarned: "+((super.getgrosssales()*super.getcommission())+(basesalary));
    }
    public String toString(){
